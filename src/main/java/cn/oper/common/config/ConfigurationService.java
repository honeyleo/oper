...
import cn.oper.common.config.manage.ConfigurationManager;


public class ConfigurationService{

	private static Configuration configuration = ConfigurationManager.getInstance().getConfiguration();
